...
<div class="pick-grid"><a class="pick-card pick-card--nobuy" href="../../snapshots/QCOM-2026-09-23/"><div class="pick-card__head"><span class="pick-card__ticker">QCOM</span><span class="pick-card__name">Qualcomm</span><span class="verdict verdict-nobuy">매수불가</span></div><p class="pick-card__lead">매수불가 <span class="verdict-reason">(이격과대)</span> · 현재가 $198.27</p><div class="pick-card__badges"><span class="pick-badge">추세 <b>Stage 2</b></span><span class="pick-badge">구조 <b>TT 6/7</b></span></div><div class="pick-card__foot">스냅샷 보기 ›</div></a></div>
