...
<div class="pick-grid"><a class="pick-card pick-card--nobuy" href="../../snapshots/IREN-2026-09-23/"><div class="pick-card__head"><span class="pick-card__ticker">IREN</span><span class="pick-card__name">IREN Limited</span><span class="verdict verdict-nobuy">매수불가</span></div><p class="pick-card__lead">매수불가 <span class="verdict-reason">(기준미달)</span> · 현재가 $48.55</p><div class="pick-card__badges"><span class="pick-badge">추세 <b>Stage 1</b></span><span class="pick-badge">구조 <b>TT 3/7</b></span></div><div class="pick-card__foot">스냅샷 보기 ›</div></a></div>
