...
<div class="m-sum m-sum--nobuy"><div class="m-sum__top"><span class="m-sum__px">$47.88</span><span class="verdict verdict-nobuy">매수불가</span> <span class="verdict-reason">(기준미달)</span></div><div class="m-sum__sub">기준일 2026-09-24</div><p class="m-why">상승 구조 조건이 매수 기준에 못 미칩니다.</p></div>

<div class="m-box m-checks"><div class="m-ck m-ck--no"><i>✕</i><span>바닥 다지기 구간 <small>(Stage 1)</small></span></div><div class="m-ck m-ck--no"><i>✕</i><span>상승 구조 7개 중 3개 충족 <small>(기준 5개)</small></span></div><div class="m-ck m-ck--warn"><i>!</i><span>주봉 저항 아래 자리 <small>(첫 저항 +16.1%)</small></span></div><div class="m-ck m-ck--no"><i>✕</i><span>기준미달</span></div></div>

<p class="m-more"><a href="../../snapshots/IBIT-2026-09-24/">분석 스냅샷 전체 보기 ›</a></p>
...
??? note "지난 분석 메모 (작성 2026-08-23 · 지금 판정과 다를 수 있음)"
