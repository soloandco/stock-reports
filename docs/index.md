...
<div class="stat-grid"><a class="stat-card" href="watchlist/"><div class="stat-card__num">43</div><div class="stat-card__label">관찰 종목</div></a><a class="stat-card stat-card--cand" href="snapshots/"><div class="stat-card__num">3</div><div class="stat-card__label">매수후보</div></a><a class="stat-card stat-card--watch" href="snapshots/"><div class="stat-card__num">19</div><div class="stat-card__label">매수관찰</div></a><a class="stat-card" href="positions/"><div class="stat-card__num">22</div><div class="stat-card__label">오픈 포지션</div></a><a class="stat-card" href="performance/"><div class="stat-card__num">📈</div><div class="stat-card__label">전략 성과</div></a><a class="stat-card" href="snapshots/"><div class="stat-card__num">49</div><div class="stat-card__label">스냅샷</div></a><a class="stat-card" href="alerts/"><div class="stat-card__num">54</div><div class="stat-card__label">알림</div></a></div>

## 바로 가기

- 📋 **관찰 종목** 43개 — [목록 보기](watchlist/index.md)
- 💹 **오픈 포지션** 22개 — [수익률·R·시드 계산 보기](positions/index.md)
- 📈 **전략 성과** — [손익비·기대값·승률 보기](performance/index.md)
- 📊 **분석 스냅샷** 49건 — [최신순 보기](snapshots/index.md)
- 🔔 **알림** 54건 — [타임라인 보기](alerts/index.md)
