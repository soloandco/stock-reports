...
> **RS**: 상대강도 순위 · **신호**: 최근 20일 매집/분산(가격방향×거래량) · **거래대금 비중**: 섹터 쏠림 게이지. 수집: 2026-06-16 13:57 UTC · `--scan` 시 갱신
>
...
|---|---|---|---|---|---|---|
| 1 | Technology | +2.09 | 🔴 분산 | 2 | 5 | 23.1% |
| 2 | Industrials | +0.76 | 🔴 분산 | 4 | 5 | 11.1% |
| 3 | Materials | +0.67 | 🟢 매집 | 4 | 1 | 4.0% |
| 4 | Energy | +0.61 | 🔴 분산 | 4 | 6 | 13.9% |
| 5 | Real Estate | +0.39 | ⚪ 중립 | 5 | 5 | 1.4% |
| 6 | Health Care | +0.24 | ⚪ 중립 | 4 | 4 | 10.7% |
| 7 | Financials | +0.24 | 🟢 매집 | 6 | 4 | 13.5% |
| 8 | Consumer Staples | +0.21 | 🔴 분산 | 3 | 6 | 7.0% |
| 9 | Consumer Discretionary | +0.20 | ⚪ 중립 | 4 | 4 | 5.7% |
| 10 | Utilities | +0.11 | ⚪ 중립 | 4 | 4 | 5.2% |
| 11 | Communication | -0.04 | 🔴 분산 | 4 | 5 | 4.4% |
...
> GPU→전력→반도체→피지컬AI→기판 로테이션 추적. RS+신호로 현재 자금이 어느 테마에 집중되는지 판독. 수집: 2026-06-16 13:57 UTC
>
...
|---|---|---|---|---|---|---|
| 1 | GPU/반도체 | SOXX | +6.04 | 🔴 분산 | 3 | 5 |
| 2 | AI인프라 | ARTY | +3.55 | 🟢 매집 | 5 | 4 |
| 3 | 전력/DataCenter | VST·CEG·GEV·VRT·ETN | +1.30 | 🔴 분산 | 2 | 7 |
| 4 | 피지컬AI(로보틱스) | BOTZ | +0.59 | 🔴 분산 | 3 | 5 |
...
> 수집: 2026-06-16 13:57 UTC · 출처: [CNN Markets](https://edition.cnn.com/markets/fear-and-greed)
...
> 수집: 2026-06-16 13:57 UTC · `python monitor.py --scan` 실행 시 갱신

| 지수 | 현재값 | 전일比 | 등급 | 시장 국면 | 신규 진입 |
|------|--------|--------|------|---------|---------|
| VIX (미국 S&P500) | 16.02 | -1.66 | ⚪ 중립 | 강한 상승 | ✅ 신규 진입 허용 |
