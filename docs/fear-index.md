...
> **RS**: 상대강도 순위 · **신호**: 최근 20일 매집/분산(가격방향×거래량) · **거래대금 비중**: 섹터 쏠림 게이지. 수집: 2026-09-22 02:32 UTC · `--scan` 시 갱신
>
...
|---|---|---|---|---|---|---|
| 1 | Technology | +1.33 | 🟢 매집 | 7 | 3 | 11.4% |
| 2 | Energy | +1.29 | ⚪ 중립 | 4 | 4 | 19.0% |
| 3 | Health Care | +0.78 | ⚪ 중립 | 4 | 4 | 10.7% |
| 4 | Financials | +0.32 | 🔴 분산 | 4 | 5 | 16.1% |
| 5 | Materials | +0.26 | 🔴 분산 | 2 | 7 | 4.0% |
| 6 | Industrials | +0.20 | 🔴 분산 | 5 | 7 | 11.1% |
| 7 | Communication | +0.14 | 🔴 분산 | 3 | 6 | 5.4% |
| 8 | Real Estate | +0.14 | 🔴 분산 | 1 | 7 | 1.8% |
| 9 | Consumer Staples | +0.12 | 🔴 분산 | 3 | 6 | 6.8% |
| 10 | Consumer Discretionary | -0.14 | 🔴 분산 | 0 | 5 | 6.5% |
| 11 | Utilities | -0.30 | 🔴 분산 | 3 | 4 | 7.4% |

### 한국 (KODEX/TIGER 섹터 ETF)

| 순위 | 섹터 | RS | 신호 | 매집일 | 분산일 | 거래대금 비중 |
|---|---|---|---|---|---|---|
| 1 | 반도체 | +3.96 | ⚪ 중립 | 4 | 4 | 65.4% |
| 2 | 건설 | +1.86 | 🟢 매집 | 7 | 0 | 6.4% |
| 3 | 은행 | +1.31 | ⚪ 중립 | 3 | 3 | 3.9% |
| 4 | 화장품 | +1.21 | 🔴 분산 | 2 | 7 | 7.2% |
| 5 | 운송 | +0.46 | 🔴 분산 | 2 | 3 | 0.0% |
| 6 | 철강 | +0.16 | ⚪ 중립 | 3 | 3 | 0.1% |
| 7 | 에너지화학 | +0.09 | 🟢 매집 | 4 | 3 | 0.1% |
| 8 | 증권 | -0.06 | 🟢 매집 | 5 | 4 | 2.1% |
| 9 | 자동차 | -0.06 | 🔴 분산 | 3 | 4 | 0.9% |
| 10 | 2차전지 | -0.09 | ⚪ 중립 | 4 | 4 | 12.7% |
| 11 | 소프트웨어 | -0.38 | 🔴 분산 | 1 | 5 | 0.2% |
| 12 | IT | -0.86 | 🔴 분산 | 3 | 6 | 0.0% |
| 13 | 바이오 | -1.31 | 🔴 분산 | 2 | 4 | 0.7% |
| 14 | 미디어컨텐츠 | -1.53 | ⚪ 중립 | 5 | 5 | 0.2% |

## 테마별 자금 흐름 (로테이션)

> GPU→전력→반도체→피지컬AI→기판 로테이션 추적. RS+신호로 현재 자금이 어느 테마에 집중되는지 판독. 수집: 2026-09-22 02:32 UTC
>
...
|---|---|---|---|---|---|---|
| 1 | GPU/반도체 | SOXX | +2.55 | 🟢 매집 | 5 | 4 |
| 2 | AI인프라 | ARTY | +2.12 | 🟢 매집 | 3 | 2 |
| 3 | 전력/DataCenter | VST·CEG·GEV·VRT·ETN | +0.31 | 🔴 분산 | 4 | 5 |
...
> 수집: 2026-09-22 02:32 UTC · 출처: [CNN Markets](https://edition.cnn.com/markets/fear-and-greed)
...
> 수집: 2026-09-22 02:32 UTC · `python monitor.py --scan` 실행 시 갱신

| 지수 | 현재값 | 전일比 | 등급 | 시장 국면 | 신규 진입 |
|------|--------|--------|------|---------|---------|
| VIX (미국 S&P500) | 14.87 | +0.06 | 🟢 탐욕 | 강한 상승 | ✅ 신규 진입 허용 |
