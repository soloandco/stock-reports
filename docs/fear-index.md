...
> **RS**: 상대강도 순위 · **신호**: 최근 20일 매집/분산(가격방향×거래량) · **거래대금 비중**: 섹터 쏠림 게이지. 수집: 2026-09-26 12:43 UTC · `--scan` 시 갱신
...
> GPU→전력→반도체→피지컬AI→기판 로테이션 추적. RS+신호로 현재 자금이 어느 테마에 집중되는지 판독. 수집: 2026-09-26 12:43 UTC
>
...
> 수집: 2026-09-26 12:43 UTC · 출처: [CNN Markets](https://edition.cnn.com/markets/fear-and-greed)
...
> 수집: 2026-09-26 12:43 UTC · `python monitor.py --scan` 실행 시 갱신
