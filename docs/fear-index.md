...
| [**AVGO**](snapshots/AVGO-2026-09-11.md) | [Broadcom](snapshots/AVGO-2026-09-11.md) | 2026-09-11 | <span class="verdict-sort">9</span><span class="verdict verdict-nobuy">매도후보</span> | 3 | 2/8 |
...
> **RS**: 상대강도 순위 · **신호**: 최근 20일 매집/분산(가격방향×거래량) · **거래대금 비중**: 섹터 쏠림 게이지. 수집: 2026-09-11 06:35 UTC · `--scan` 시 갱신
>
...
| 순위 | 섹터 | RS | 신호 | 매집일 | 분산일 | 거래대금 비중 |
|---|---|---|---|---|---|---|
| 1 | 반도체 | +3.66 | 🟢 매집 | 5 | 4 | 61.2% |
| 2 | 건설 | +1.89 | 🟢 매집 | 9 | 0 | 6.2% |
| 3 | 은행 | +1.14 | 🔴 분산 | 3 | 5 | 3.4% |
| 4 | 화장품 | +1.11 | 🔴 분산 | 2 | 7 | 8.3% |
| 5 | 운송 | +0.22 | 🟢 매집 | 4 | 3 | 0.1% |
| 6 | 에너지화학 | +0.05 | 🟢 매집 | 5 | 2 | 0.3% |
| 7 | 철강 | -0.14 | 🟢 매집 | 5 | 2 | 0.1% |
| 8 | 증권 | -0.16 | ⚪ 중립 | 4 | 4 | 2.1% |
| 9 | 자동차 | -0.21 | 🔴 분산 | 2 | 4 | 0.8% |
| 10 | 2차전지 | -0.22 | 🟢 매집 | 5 | 4 | 16.4% |
| 11 | 소프트웨어 | -0.71 | 🔴 분산 | 2 | 4 | 0.1% |
| 12 | IT | -1.07 | ⚪ 중립 | 3 | 3 | 0.0% |
| 13 | 바이오 | -1.31 | ⚪ 중립 | 3 | 3 | 0.6% |
| 14 | 미디어컨텐츠 | -1.74 | 🔴 분산 | 2 | 4 | 0.1% |

## 테마별 자금 흐름 (로테이션)

> GPU→전력→반도체→피지컬AI→기판 로테이션 추적. RS+신호로 현재 자금이 어느 테마에 집중되는지 판독. 수집: 2026-09-11 06:35 UTC
>
...
|---|---|---|---|---|---|---|
| 1 | GPU/반도체 | SOXX | +2.05 | 🔴 분산 | 3 | 5 |
| 2 | AI인프라 | ARTY | +1.79 | 🟢 매집 | 5 | 3 |
| 3 | 전력/DataCenter | VST·CEG·GEV·VRT·ETN | +0.40 | 🔴 분산 | 2 | 7 |
| 4 | 피지컬AI(로보틱스) | BOTZ | -0.17 | 🔴 분산 | 5 | 7 |
...
> 수집: 2026-09-11 06:35 UTC · 출처: [CNN Markets](https://edition.cnn.com/markets/fear-and-greed)
...
> 수집: 2026-09-11 06:35 UTC · `python monitor.py --scan` 실행 시 갱신
